...
def make_dataset(
    ...
    fidx = [int(fname.split('.')[0]) for fname in filenames]
    sorted_fidx = sorted(range(len(fidx)), key=lambda x : fidx[x])
    return [instances[idx] for idx in sorted_fidx]


class DatasetFolderSorted(VisionDataset):
    ...
    def __init__(
        ...
        super(DatasetFolderSorted, self).__init__(root, transform=transform,
...
class ImageFolderSorted(DatasetFolderSorted):
    ...
    def __init__(
        ...
        super(ImageFolderSorted, self).__init__(root, loader, IMG_EXTENSIONS if is_valid_file is None else None,
                                          transform=transform,
                                          target_transform=target_transform,
...
class TCN_Train_Dataset(Dataset):
    def __init__(self, image_path, positive_frame_margin=10, negative_frame_margin=30, transform=None):
    ...
    def __getitem__(self, idx):
        ...
        n_idx = self.sample_positive_frame_index(idx)
